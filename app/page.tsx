...
Beginner</div>
      ...
      <section className="px-4 hero w-full flex flex-col items-center my-18">
        ...
        <div className="font-bold leading-12 text-4xl text-center w-full capitalize mb-12">
         ...
         <ul>
          <li className="flex justify-start items-center"><img className="w-[32px]" src="bullet.png"/>Are you tired of buying from Nigerian vendors and making tiny profits?.</li>
          <li className="flex justify-start items-center"><img className="w-[32px]" src="bullet.png"/>Are you scared of losing money to scammers in China?</li>
          <li className="flex justify-start items-center"><img className="w-[32px]" src="bullet.png"/>Confused about shipping, agents, and product sourcing?</li>
         </ul>
        <h5 className="text-sm mt-7 text-center mb-8">This class is for you. In just 5 days, I’ll show you how to:</h5>
        <ul>
          <li className="flex justify-start items-center"><img className="w-[32px]" src="bullet.png"/>Import products safely from China (without travel or scams)</li>
          <li className="flex justify-start items-center"><img className="w-[32px]" src="bullet.png"/>Get direct access to trusted agents & suppliers</li>
          <li className="flex justify-start items-center"><img className="w-[32px]" src="bullet.png"/>Start with as little as ₦50k and scale fast</li>
          <li className="flex justify-start items-center"><img className="w-[32px]" src="bullet.png"/>Resell and make 200%+ profit like my other students</li>
         </ul>
         <button className="cta w-[50%] mt-5 font-medium text-sm p-4 rounded bg-red-400">Click here to Join the Class Now — Only ₦3,000</button>
      </section>
      <section className="mb-18 px-4 w-full flex flex-col items-center text-center testimonials bg-gray-100 py-18">
        ...
        <div className="testimony-grid grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="testimony mt-10 py-12 mx-auto w-full flex flex-col gap-y-4 justify-center items-center bg-white rounded">
            <div className="profile-pic w-[286px] rounded">
              <img className="w-full overflow-hidden rounded" src="/R1.jpg" alt="testimony pic" />
            </div>
      ...
      <section className="w-full mt-18 mb-18 px-4">
        ...
        <ul>
          <li className="flex justify-start items-center"><img className="w-[32px]" src="check-mark.png"/>How to find trusted China suppliers.</li>
          <li className="flex justify-start items-center"><img className="w-[32px]" src="check-mark.png"/>How to calculate total cost (products, shipping, clearing).</li>
          <li className="flex justify-start items-center"><img className="w-[32px]" src="check-mark.png"/>How to talk to agents (with a template).</li>
          <li className="flex justify-start items-center"><img className="w-[32px]" src="check-mark.png"/>Products to AVOID so you don’t lose money.</li>
          <li className="flex justify-start items-center"><img className="w-[32px]" src="check-mark.png"/>20 HOT-SELLING items Nigerians buy like crazy.</li>
          <li className="flex justify-start items-center"><img className="w-[32px]" src="check-mark.png"/>How to receive your items safely.</li>
          <li className="flex justify-start items-center"><img className="w-[32px]" src="check-mark.png"/>BONUS: Access to my 3 trusted agents & 2 product sourcing plug-ins.</li>
          <li className="flex justify-start items-center"><img className="w-[32px]" src="check-mark.png"/>BONUS: My personal supplier list.</li>
          <li className="flex justify-start items-center"><img className="w-[32px]" src="check-mark.png"/>BONUS: Agent contact script (no begging or fear).</li>
          <li className="flex justify-start items-center"><img className="w-[32px]" src="check-mark.png"/>BONUS: Live Zoom call access for Q&A.</li>
          <li className="flex justify-start items-center"><img className="w-[32px]" src="check-mark.png"/>BONUS: Certificate of Completion.</li>
        </ul>
      ...
      <section className="px-4 mb-18">
        ...
        <button className="cta w-full mt-5 font-medium text-sm p-4 rounded bg-red-400">Click here to Join the Class Now — Only ₦3,000</button>
      </section>
