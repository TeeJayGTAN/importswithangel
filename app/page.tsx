  ...
  return (
    <div className="w-full">
      ...
      <section className="px-4 hero w-full flex flex-col items-center ">
        <div className="headline font-bold mt-18 leading-12 text-4xl text-center w-full">Learn How to Import Products from China Without Getting Scammed — Even If You’re a Total
Beginner</div>
        <div className="subheadline text-base pt-7 font-medium text-center w-full"> Join 1,500+ Nigerians making 2x–5x profit reselling products they import directly from China. ₦3,000 Promo Ends in 5 Days! (Then the price goes back to ₦10,000).</div>
        <div className="video">
        ...
        <button className="cta w-[50%] mt-5 font-medium text-sm p-4 rounded bg-red-400"><span className="text-lg text-red-700">Step 2 of 2: </span><br/>Click here to Join the Class Now — Only ₦3,000</button>
      ...
      <section className="px-4 hero w-full flex flex-col items-center my-18">
        ...
        <div className="font-bold leading-12 text-4xl text-center w-full capitalize mb-12">
         ...
         <ul className="flex flex-col justify-center items-start gap-y-5">
          <li className="flex justify-start items-center gap-x-4"><img className="w-[24px]" src="bulletpoint.png"/>Are you tired of buying from Nigerian vendors and making tiny profits?.</li>
          <li className="flex justify-start items-center gap-x-4"><img className="w-[24px]" src="bulletpoint.png"/>Are you scared of losing money to scammers in China?</li>
          <li className="flex justify-start items-center gap-x-4"><img className="w-[24px]" src="bulletpoint.png"/>Confused about shipping, agents, and product sourcing?</li>
         </ul>
        <h5 className="text-sm mt-7 text-center mb-8">This class is for you. In just 5 days, I’ll show you how to:</h5>
        <ul className="flex flex-col justify-center items-start gap-y-5">
          <li className="flex justify-start items-center gap-x-4"><img className="w-[24px]" src="bulletpoint.png"/>Import products safely from China (without travel or scams)</li>
          <li className="flex justify-start items-center gap-x-4"><img className="w-[24px]" src="bulletpoint.png"/>Get direct access to trusted agents & suppliers</li>
          <li className="flex justify-start items-center gap-x-4"><img className="w-[24px]" src="bulletpoint.png"/>Start with as little as ₦50k and scale fast</li>
          <li className="flex justify-start items-center gap-x-4"><img className="w-[24px]" src="bulletpoint.png"/>Resell and make 200%+ profit like my other students</li>
         </ul>
         <button className="cta w-[50%] mt-10 font-medium text-sm p-4 rounded bg-red-400">Click here to Join the Class Now — Only ₦3,000</button>
      </section>
      <section className="mb-18 px-4 w-full flex flex-col items-center text-center testimonials bg-gray-100 py-18">
        <h3 className="font-bold leading-12 text-4xl text-center w-full capitalize">Real Results. Real People.</h3>
        <h5 className="text-sm mt-7 text-center mb-8">Don’t take my word for it — here’s what past students are saying.</h5>
        ...
        <div className="testimony-grid grid grid-cols-1 md:grid-cols-3 gap-4">
          {
            testimonials.map((item,index) => 
              <div key={index} className="testimony mt-10 py-12 mx-auto w-full flex flex-col gap-y-4 justify-center items-center bg-white rounded">
                <div className="profile-pic w-[286px] rounded">
                  <img className="w-full overflow-hidden rounded" src={item.url} alt="testimony pic" />
                </div>
                ...
                <div className="testimonial-name mt-6 text-lg font-bold">{item.name}</div>
      ...
      <section className="w-full mt-18 mb-18 px-4">
        <h3 className="font-bold leading-12 text-4xl text-center w-full capitalize">What you'll learn in this class</h3>
        <h5 className="text-sm mt-7 text-center mb-8">Inside the Importation Masterclass, You’ll Discover:</h5>
        <ul className="flex flex-col justify-center items-start gap-y-5">
          <li className="flex justify-start items-center gap-x-4"><img className="w-[32px]" src="check-mark.png"/>How to find trusted China suppliers.</li>
          <li className="flex justify-start items-center gap-x-4"><img className="w-[32px]" src="check-mark.png"/>How to calculate total cost (products, shipping, clearing).</li>
          <li className="flex justify-start items-center gap-x-4"><img className="w-[32px]" src="check-mark.png"/>How to talk to agents (with a template).</li>
          <li className="flex justify-start items-center gap-x-4"><img className="w-[32px]" src="check-mark.png"/>Products to AVOID so you don’t lose money.</li>
          <li className="flex justify-start items-center gap-x-4"><img className="w-[32px]" src="check-mark.png"/>20 HOT-SELLING items Nigerians buy like crazy.</li>
          <li className="flex justify-start items-center gap-x-4"><img className="w-[32px]" src="check-mark.png"/>How to receive your items safely.</li>
          <li className="flex justify-start items-center gap-x-4"><img className="w-[32px]" src="check-mark.png"/>BONUS: Access to my 3 trusted agents & 2 product sourcing plug-ins.</li>
          <li className="flex justify-start items-center gap-x-4"><img className="w-[32px]" src="check-mark.png"/>BONUS: My personal supplier list.</li>
          <li className="flex justify-start items-center gap-x-4"><img className="w-[32px]" src="check-mark.png"/>BONUS: Agent contact script (no begging or fear).</li>
          <li className="flex justify-start items-center gap-x-4"><img className="w-[32px]" src="check-mark.png"/>BONUS: Live Zoom call access for Q&A.</li>
          <li className="flex justify-start items-center gap-x-4"><img className="w-[32px]" src="check-mark.png"/>BONUS: Certificate of Completion.</li>
        </ul>
        
        <h5 className="text-sm mt-7 text-center mb-8">All for just ₦3,000(for a limited time) After 5 days, the price goes back to ₦10,000</h5>
      ...
      <section className="px-4 mb-18 w-full">
        <h3 className= "font-bold leading-12 text-4xl text-center w-full capitalize mb-12">Join 1,500+ Others Who’ve Learned to Import With Just ₦3,000.</h3>
        <h5 className="text-sm mt-7 text-center mb-8">Don’t miss out. This knowledge could change your income forever.</h5>
        <button className="cta w-[45%] block mx-auto mt-5 font-medium text-sm p-4 rounded bg-red-400">Click here to Join the Class Now — Only ₦3,000</button>
      </section>
      
      <section className="mb-18 px-4 w-full flex flex-col items-center text-center testimonials bg-gray-100 py-18">
        <h3 className="font-bold leading-12 text-4xl text-center w-full capitalize">WHO IS ANGEL?</h3>
        <h5 className="text-sm mt-7 text-center mb-8">Hi, I’m Angel, a full-time importer and trainer. I’ve helped over 1,500 Nigerians learn to import from China the RIGHT way — without stress or scams. Now it’s your turn!.</h5>
        <div className="profile-pic w-[286px] rounded">
              <img className="w-full overflow-hidden rounded" src="/angel.jpeg" alt="angel pic" />
            </div>
      </section>
